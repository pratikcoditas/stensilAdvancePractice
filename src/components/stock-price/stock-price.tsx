...
export class StockPrice {
    ...
    fetchStockPrice(stockSymbol: string) {
        this.loading = true;
      fetch(
        `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${stockSymbol}&apikey=${PR_API_KEY}`
      )
        .then(res => {
          if (res.status !== 200) {
    ...
    render() {
      ...
      if(this.loading) {
          dataContent = <pr-spinner></pr-spinner>;
      }
      return [
